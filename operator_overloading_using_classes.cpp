...
stringg * stringg::operator/(int divisor) {
    ...
    stringg original;
    stringg *temp = new stringg[divisor];
...
int main(){
    ...
    stringg *firstword;
    firstword = new stringg;	// object firstword from stringg to grab the firstword thing in the  file
    stringg second;// object second from stringg to grab the second thing in the file
    char opert;// char made for when we pass the operation in the file
    int x;// int made for when we pass the  value from the file
